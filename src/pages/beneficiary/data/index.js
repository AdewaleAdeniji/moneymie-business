...
export const beneficiaries = async (companyid) => {
  ...
  const res = await axios.get(
    `${config.baseUrl}/beneficiary/getByCompanyId/${companyid}`,
    {
...
export const addBen = async (payload) => {
  ...
  const res = await axios.post(
    `${config.baseUrl}/user/beneficiary/add`,
    payload,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
...
export const deleteBen = async (beneficiary_id) => {
  ...
  const res = await axios.delete(
    `${config.baseUrl}/beneficiary/company/${beneficiary_id}`,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
  );
...
export const updateBen = async (payload) => {
  ...
  token = token?.token ? token.token : "";
  const res = await axios.post(
    `${config.baseUrl}/beneficiary/company/${payload.id}`,
    payload,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
